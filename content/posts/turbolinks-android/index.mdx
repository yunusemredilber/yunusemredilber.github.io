...
Ben bu yazıda MIT lisansıyla geliştirmekte olduğum basit [groupath](https://github.com/yunusemredilber/groupath) projemi kullanacağım, çünkü işimiz sadece android tarafında olacak.
...
`build.gradle` dosyamızdaki (uygulamanın, projenin değil!) dependencylerine eklememiz gereken 3 _implementasyon_ var:
